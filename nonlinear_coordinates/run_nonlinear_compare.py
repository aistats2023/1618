...
while True:
    ...
    value_iter_error.append(evaluate_value_func(LQR_example, value_mat, value_cons))
...
while True:
    ...
    obs, cost, next_obs = collect_samples(LQR_example, int(20000 * np.sqrt(i)))
...
while True:
    ...
    fvi_error.append(evaluate_value_boost(LQR_example, fvi_func))
...
# saves the data
path = "../data/"
filename = "nonlinear" + str(gamma) + "_tol" + str(tol) + "_"
